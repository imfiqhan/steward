...
//
//   - dist/app.css — Tailwind v4 + Basecoat 1.0.2 base, compiled by the Tailwind
//     standalone binary (no Node at runtime or build; see tools/assets)
//   - dist/style-*.css — one bundle per Basecoat style pack, carrying the
//     component layer the shared bundle leaves out; Config.Style picks which
//     one a page links
